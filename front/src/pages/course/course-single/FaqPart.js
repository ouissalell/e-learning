...
const FaqPart = () => {
    ...
    const markAllResponsesAsFalse = async () => {
        try {
            ...
            const firstFalseResponse = await axios.get(`http://localhost:8801/api/repense/fetchFirstFalseResponseQuestion/${idq}/${userid}`);
            ...
            const responseAll = await axios.get(`http://localhost:8801/api/quiz/getQuiz/${id}`);
