...
const handleSubmit = async (e) => {
    ...
    try {
        ...
        await axios.post("http://localhost:8800/api/question/createQuestion", {
    ...
    const fetchQuiz = async () => {
        try {
            const response = await axios.get(`http://localhost:8800/api/quiz/getQuizId/${id}`);
    ...
    const fetchQuestion = async () => {
        try {
            const response = await axios.get(`http://localhost:8800/api/question/getQuestions/${id}`);
