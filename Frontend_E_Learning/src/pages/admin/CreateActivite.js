...
useEffect(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post("http://localhost:8800/api/activite/createActivite", {
                titre : inputs.titre,
    ...
    const fetchActivite = async () => {
        try {
            const response = await axios.get(`http://localhost:8800/api/activite/getAllActiviteId/${id}`);
                                            ...
                                            <div className='sous-activite'>
                                                {activites.categorie && activites.categorie === "text" ?
                                                    ...
                                                    : activites.categorie === "image" ?
                                                        <div className='modal-activite-text-aff'>
                                                            <img src={`http://localhost:8800/api/image/${activites.contenu}`} alt="image" />
                                                        </div>
                                                        : activites.categorie === "video" ?
                                                            <div className='modal-activite-text-aff'>
                                                                <video controls>
                                                                    <source src={`http://localhost:8800/api/video/${activites.contenu}`} type="video/mp4" />
